...
This project uses rule-based agent instructions. All agents working on this codebase must read and follow ./8-Agent-Instructions/base-rule.md# MANDATORY: READ BEFORE ANY ACTION
