...
namespace HotshotLogistics.Tests.Communication
{
    ...
    public class RealtimeServiceTests
    {
        ...
        [Fact]
        public async System.Threading.Tasks.Task BroadcastJobStatusUpdate_ShouldSendToJobGroup()
        {
            // Arrange
            var jobId = "job-123";
        ...
        [Fact]
        public async System.Threading.Tasks.Task BroadcastLocationUpdate_ShouldSendToJobGroup()
        {
            // Arrange
            var jobId = "job-123";
        ...
        [Fact]
        public async System.Threading.Tasks.Task BroadcastDriverStatusChange_ShouldSendToDriverGroupAndAdmins()
        {
            // Arrange
            var driverId = 123;
        ...
        [Fact]
        public async System.Threading.Tasks.Task BroadcastNewJobAvailable_ShouldSendToAvailableDrivers()
        {
            // Arrange
            var job = new ContractsJobDto
            {
                ...
                ScheduledPickupTime = System.DateTime.UtcNow
            };
        ...
        [Fact]
        public async System.Threading.Tasks.Task SendNotification_WithUserId_ShouldSendToSpecificUser()
        {
            // Arrange
        ...
        [Fact]
        public async System.Threading.Tasks.Task SendNotification_WithoutUserId_ShouldBroadcastToAll()
        {
            // Arrange
            var message = new NotificationMessageDto
            {
        ...
        [Fact]
        public async System.Threading.Tasks.Task SendToGroup_ShouldSendMessageToGroup()
        {
            // Arrange
        ...
        [Fact]
        public async System.Threading.Tasks.Task SendToUser_ShouldSendMessageToUser()
        {
            // Arrange
            var userId = "user-123";
            var method = "TestMethod";
        ...
        [Fact]
        public async System.Threading.Tasks.Task BroadcastJobStatusUpdate_WhenExceptionThrown_ShouldLogErrorAndRethrow()
        {
            // Arrange
            var jobId = "job-123";
            var status = JobStatus.EnRoute;
            var expectedException = new System.Exception("SignalR error");
        ...
        [Fact]
        public async System.Threading.Tasks.Task AddUserToGroup_ShouldLogIntent()
        {
            // Arrange
            var userId = "user-123";
            var groupName = "test-group";
        ...
        [Fact]
        public async System.Threading.Tasks.Task RemoveUserFromGroup_ShouldLogIntent()
        {
            // Arrange
            var userId = "user-123";
            var groupName = "test-group";
